...
export function UnpostTransactionPage() {
  ...
  const getCurrentData = () => {
    switch (activeTab) {
      ...
      case 'Division': return divisionData;
      case 'Group Schedule': return groupScheduleData;
      case 'Pay House': return payHouseData;
      case 'Section': return sectionData;
      case 'Unit': return unitData;
      default: return tkGroupData;
    }
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="flex-1 relative z-10 p-6">
        <div className="max-w-7xl mx-auto relative">
          {/* Page Header */}
          <div className="bg-blue-600 text-white px-6 py-4 rounded-t-lg mb-0">
