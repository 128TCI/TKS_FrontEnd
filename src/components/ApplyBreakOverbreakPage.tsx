...
import { Calendar, Clock, Check, Search, X, Calculator, Save } from 'lucide-react';
...
export function ApplyBreakOverbreakPage() {
  ...
  const [showCalendar, setShowCalendar] = useState<'dateToApply' | 'dateFrom' | 'dateTo' | null>(null);
  ...
  const handleCalendarClick = (field: 'dateToApply' | 'dateFrom' | 'dateTo', event: React.MouseEvent<HTMLButtonElement>) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Search employees by code or name</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Compute break adjustments</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm flex-1"
                    />
                    <button className="p-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors flex items-center justify-center">
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-100 border-b border-gray-200">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">EmpCode</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">WorkShift</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">RawDate</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">RawBreak1Out</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">RawBreak1In</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">RawBreak3Out</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">RawBreak3In</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">AfterGrace</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">WithinGrace</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-100 border-b border-gray-200">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">EmpCode</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">Deduct</th>
                        <th className="px-4 py-2 text-left text-xs text-gray-600">AppDate</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
      ...
      {showCalendar && (
        <CalendarPopup
          value={showCalendar === 'dateToApply' ? dateToApply : showCalendar === 'dateFrom' ? dateFrom : dateTo}
