...
export function DeleteIncompleteLogsPage() {
  ...
  const handleConfirmDelete = () => {
    console.log('Delete incomplete logs confirmed');
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Review incomplete logs carefully</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Click delete to remove entries</span>
                    </div>
                  </div>
                </div>
              </div>
