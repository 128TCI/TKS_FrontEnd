...
export function LoginPage({ onLogin, onForgotPassword }: LoginPageProps) {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-lime-200 via-green-400 to-lime-200 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob animation-delay-4000"></div>
      </div>
