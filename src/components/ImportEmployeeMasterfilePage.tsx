                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    <button 
                      ...
                      className="px-6 py-2.5 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <div className="overflow-x-auto bg-white">
                <table className="w-full">
                  ...
                  <tbody>
                    {isProcessing ? (
                      <tr>
                        <td colSpan={28} className="px-4 py-8">
                      ...
                      <tr>
                        <td colSpan={28} className="px-4 py-12 text-center text-gray-500 text-sm">
