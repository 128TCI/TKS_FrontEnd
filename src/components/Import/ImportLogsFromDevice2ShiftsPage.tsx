          ...
          <div className="bg-white rounded-b-lg shadow-lg p-6 relative">
              ...
              <div className="lg:col-span-3 bg-gray-50 rounded-lg border border-gray-200 p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <option value="B3-TFT-U_DATFILE">B3-TFT-U_DATFILE</option>
            ...
            <div className="mb-6 bg-gray-50 rounded-lg border border-gray-200 p-5">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {filteredEmployees.map((employee) => (
                      <tr key={employee.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 text-sm text-gray-600">{employee.name}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="mt-3 flex items-center justify-between text-xs text-gray-500">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button className="px-2 py-1 rounded border border-gray-300 hover:bg-gray-100 text-xs">2</button>
                  <button className="px-2 py-1 rounded border border-gray-300 hover:bg-gray-100 text-xs">3</button>
                  <button className="px-2 py-1 rounded border border-gray-300 hover:bg-gray-100 text-xs">4</button>
                  <button className="px-2 py-1 rounded border border-gray-300 hover:bg-gray-100 text-xs">5</button>
                  <span className="px-2">...</span>
                  <button className="px-2 py-1 rounded border border-gray-300 hover:bg-gray-100 text-xs">71</button>
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              <div className="px-5 py-3 bg-white border-b border-gray-200">
                <h3 className="text-gray-900">Device Log Preview</h3>
              </div>
