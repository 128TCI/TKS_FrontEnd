...
import { Calendar, AlertCircle, Check, Save, RotateCcw, Users, Building2, Briefcase, Network, CalendarClock, Wallet, Grid, Box, Send } from 'lucide-react';
...
export function PostProcessedTimekeepingPage() {
  ...
  const [noOfDaysWork, setNoOfDaysWork] = useState(false);
  const [leaveAndAbsences, setLeaveAndAbsences] = useState(false);
  const [undertime, setUndertime] = useState(false);
  ...
  const handleSelectAll = () => {
    const allSelected = tardiness && allowances && noOfDaysWork && leaveAndAbsences && undertime && overtime;
    setTardiness(!allSelected);
    setAllowances(!allSelected);
    setNoOfDaysWork(!allSelected);
    setLeaveAndAbsences(!allSelected);
    setUndertime(!allSelected);
    setOvertime(!allSelected);
  };
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Post Processed Timekeeping Transaction</h1>
          </div>
          ...
          <div className="bg-white rounded-b-lg shadow-lg p-6 relative">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Finalize and post processed timekeeping transactions to the payroll system. Lock attendance records for the selected period and prepare data for payroll processing.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Set date range for posting</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Batch transaction posting</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-5">
                  <div className="mb-3">
                    <h3 className="text-sm text-gray-700">Option</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-y-2 gap-x-8">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={tardiness}
                        onChange={(e) => setTardiness(e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={leaveAndAbsences}
                        onChange={(e) => setLeaveAndAbsences(e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={allowances}
                        onChange={(e) => setAllowances(e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={undertime}
                        onChange={(e) => setUndertime(e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={noOfDaysWork}
                        onChange={(e) => setNoOfDaysWork(e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={tardiness && allowances && noOfDaysWork && leaveAndAbsences && undertime && overtime}
