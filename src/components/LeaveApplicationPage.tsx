      ...
      <div className="flex-1 relative z-10 p-6">
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Import Leave Application</h1>
            <p className="text-white opacity-90 text-sm mt-1">Import and manage leave applications for employees</p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Import leave application records from Excel or CSV files. Select the TKS groups and date range to process leave applications.
                  </p>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pl-3 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                        />
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs text-gray-600">Num Approved Hrs</th>
