...
export function UpdateTimeFlagBreaksPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const _ByUpdateResponse = await apiClient.post("/Utilities/UpdateTimeFlagBreaks_byDate", payload);
      ...
      if (isSuccessByUpdate) {     
        await showSuccessModal('Time flag on set policy successfully updated.');
        setSelectedGroups([]);
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Utility to Update the Time Flag Base on set Policy of Breaks</h1>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Update time flags based on configured break policies. Apply break time rules and automatically flag attendance records according to company break policy settings.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Auto-apply break policy rules</span>
                    </div>
                  </div>
                </div>
              </div>
