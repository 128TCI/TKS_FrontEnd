...
export function DeductAbsencesExcessPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const _ByUpdateResponse = await apiClient.post("/Utilities/ProcessOvertime24Hours_Update", payload);
      ...
      if (isSuccessByUpdate) {        
        await showSuccessModal('Deduct Absences with pay successfully updated.');
        setSelectedGroups([]);
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Deduct Absences in Excess of Total Hours with Pay if with Filed Leave</h1>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Process absence deductions when filed leave hours exceed total paid hours. Automatically adjusts leave balances and payroll calculations for accurate compensation.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Set date range for processing</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Automatic deduction calculation</span>
                    </div>
                  </div>
                </div>
              </div>
