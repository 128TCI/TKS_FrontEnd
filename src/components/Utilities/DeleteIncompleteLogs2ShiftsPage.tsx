...
export function DeleteIncompleteLogs2ShiftsPage() {  const [activeTab,          setActiveTab]          = useState<TabName>('TK Group');
  ...
  const handleAction = async () => {
    ...
    try {
      ...
      const res = await apiClient.post('/Utilities/DeleteIncompleteLogs2Shifts', payload);
      if (ApiService.isApiSuccess(res)) { await showSuccessModal('Records successfully deleted.'); resetForm(); }
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Delete Incomplete Logs 2 Shifts In A Day</h1>
          </div>
