...
export function UnpaidLunchDeductionPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const _ByUpdateResponse = await apiClient.post("/Utilities/UnpaidLunchDeduction_byDate", payload);
      ...
      if (isSuccessByUpdate) {       
        await showSuccessModal('Unpaid Lunch deduction successfully updated.');
        setSelectedGroups([]);
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Unpaid Lunch Deduction Utility</h1>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Apply unpaid lunch break deductions for selected employees. Calculate and deduct lunch break hours based on configured brackets and company policy settings.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Set date range for deductions</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Automated bracket calculation</span>
                    </div>
                  </div>
                </div>
              </div>
