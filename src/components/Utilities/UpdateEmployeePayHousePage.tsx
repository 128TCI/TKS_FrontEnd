...
export function UpdateEmployeePayHousePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    {['Bulk update pay house assignments', 'Quick search and assign',
                      'Filter by employee status', 'Select groups and employees'].map(t => (
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-5">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <button onClick={() => { setPayHouse(''); setHouse(''); }}
      ...
      <Footer />
      <PayHouseSearchModal
        isOpen={showPayHouseModal}
        onClose={() => setShowPayHouseModal(false)}
        onSelect={handlePayHouseSelect}
        payHouseItems={payHouseItems}
        loading={loadingPayHouses}
        error={payHouseError}
      />
    </div>
  );
