...
export function ProcessOvertime24HoursPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (isSuccessByUpdate) {
        await showSuccessModal('Process overtime 24hours rule successfully updated.');  
        setSelectedGroups([]);
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Process Overtime 24 Hours Rule</h1>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Apply the 24-hour overtime rule policy to process and validate overtime hours, ensuring compliance with labor regulations and company policies for maximum daily overtime limits.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Automatic 24-hour rule validation</span>
                    </div>
                  </div>
                </div>
              </div>
