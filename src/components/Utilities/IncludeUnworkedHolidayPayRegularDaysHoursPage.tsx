...
import { RefreshCw, Check, Users, Building2, Briefcase, Network, CalendarClock, Wallet } from 'lucide-react';
...
export function IncludeUnworkedHolidayPayRegularDaysHoursPage() {  const [activeTab,          setActiveTab]          = useState<TabName>('TK Group');
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Include Unworked Holiday Pay in the Regular Days/Hours</h1>
          </div>
