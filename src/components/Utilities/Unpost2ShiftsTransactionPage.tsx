...
import { Save, Check, Users, Building2, Briefcase, Network, CalendarClock, Wallet, Grid, Box } from 'lucide-react';
...
export function Unpost2ShiftsTransactionPage() {
  ...
  const handleOptionChange = (option: keyof typeof options) => {
    if (option === 'selectAll') {
      ...
      setOptions({
        tardiness: newValue, otherEarnings: newValue, noOfDaysWork: newValue,
      ...
      <div className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-400 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white font-semibold">Unpost 2 Shifts In A Day Transaction</h1>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-3">
                    Batch unpost 2-shifts-in-a-day transactions for selected employee groups. Select update options and configure the date range for processing.
                  </p>
