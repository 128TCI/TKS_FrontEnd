  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (isSuccessByUpdate) {
        await showSuccessModal('Successfully updated Allowance per Bracket.');
        setSelectedGroups([]);
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm text-gray-700 mb-3">
                                        Update allowance brackets for selected employee groups. Configure compensation brackets across multiple employees within specified date ranges efficiently.
                                    </p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                                        ...
                                        <div className="flex items-start gap-2">
                                            <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                                            <span className="text-gray-600">Specify effective date</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
