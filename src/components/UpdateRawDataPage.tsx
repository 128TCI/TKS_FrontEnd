      ...
      <div className="flex-1 relative z-10 p-6">
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg shadow-lg">
            <h1 className="text-white">Update Raw Data</h1>
          </div>
          ...
          <div className="bg-white rounded-b-lg shadow-lg p-6 relative">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 mb-2">
                    Update existing raw attendance data in bulk. Upload Excel files to modify employee time records, correct attendance entries, and update timekeeping information for selected date ranges.
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
              ...
              {/* Right Section - Update Configuration (3 columns width) */}
              <div className="lg:col-span-3 bg-gray-50 rounded-lg border border-gray-200 p-5">
                <h3 className="text-gray-900 mb-4">Update Configuration</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    <button 
                      ...
                      className="px-6 py-2.5 bg-green-600 text-white rounded hover:bg-green-700 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              <div className="px-5 py-3 bg-white border-b border-gray-200">
                <h3 className="text-gray-900">Update Data Preview</h3>
              </div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs text-gray-600">TransDate</th>
                      <th className="px-4 py-3 text-left text-xs text-gray-600">TimeIn</th>
                      <th className="px-4 py-3 text-left text-xs text-gray-600">TimeOut</th>
                      ...
                      <th className="px-4 py-3 text-left text-xs text-gray-600">Break2In</th>
                      ...
                      <tr>
                        <td colSpan={17} className="px-4 py-8">
                          <div className="flex flex-col items-center gap-3">
                            ...
                            <div className="text-sm text-gray-500">{processingProgress}%</div>
                          </div>
                        </td>
                      </tr>
                    ) : (
                      <tr>
                        <td colSpan={17} className="px-4 py-12 text-center text-gray-500 text-sm">
