...
export function TimeKeepGroupPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {showPayrollLocationModal && (
        ...
        >
          ...
          >
            ...
            {/* Payroll Location Title and Search */}
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-blue-600 mb-3">Payroll Location</h3>
            ...
            <div className="px-6 py-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
              <table className="w-full">
                ...
                <tbody>
                  {[
                    { code: '1', desc: 'Batangas Balagtas Monthly Payroll' },
                    { code: '2', desc: 'Batangas Balagtas Satellite Monthly Cash' },
                    { code: '3', desc: 'Batangas Cavite Satellite Daily Cash' },
                    { code: '4', desc: 'Batangas Cavite Satellie Monthly Cash' },
                    { code: '5', desc: 'Batangas Cavite Satellite' },
                    { code: '6', desc: 'Batangas Daily' },
                    { code: '7', desc: 'Batangas Daily Cash Payroll with Paycard' },
                    { code: '8', desc: 'Batangas Employees with the same employee number' },
                    { code: '9', desc: 'Batangas Monthly Cash 2' },
                    { code: '10', desc: 'Batangas Monthly Cash Payroll with Paycard' },
                  ]
                    .filter(item => 
                      payrollLocationSearchTerm === '' ||
                      item.code.toLowerCase().includes(payrollLocationSearchTerm.toLowerCase()) ||
                      item.desc.toLowerCase().includes(payrollLocationSearchTerm.toLowerCase())
                    )
                    .map((item, index) => (
                    <tr 
                      key={item.code}
                      ...
                      onClick={() => {
                        setPayrollLocationCode(item.code);
                        setPayrollDescription(item.desc);
                        setShowPayrollLocationModal(false);
                      }}
                    >
                      <td className="py-2 text-gray-800">{item.code}</td>
            ...
            <div className="px-6 py-3 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600">Showing 1 to 10 of 115 entries</span>
      ...
      {showForAbsentModal && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-100">
              <h2 className="text-lg font-semibold text-gray-800">Select Code</h2>
              <button
                onClick={() => setShowForAbsentModal(false)}
                className="text-gray-500 hover:text-gray-700 transition-colors"
              >
              ...
              <table className="w-full">
                <thead className="border-b-2 border-gray-300">
                  <tr>
                    ...
                    <th className="text-left py-2 text-gray-700 font-semibold">Description</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Monday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Tuesday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Wednesday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Thursday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Friday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Saturday</th>
                    <th className="text-left py-2 text-gray-700 font-semibold">Sunday</th>
                  </tr>
                </thead>
                <tbody>
                  {['ABSENT'].filter(code => 
                    code.toLowerCase().includes(forAbsentSearchTerm.toLowerCase())
                  ).map((code, index) => (
                    <tr
                      key={index}
                      className={`border-b border-gray-200 hover:bg-blue-50 cursor-pointer transition-colors ${
          ...
          >
            ...
            <div className="px-6 py-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
              <table className="w-full">
                ...
                <tbody>
                  {['NOLOGIN'].filter(code => 
                    code.toLowerCase().includes(forNoLoginSearchTerm.toLowerCase())
                  ).map((code, index) => (
                    <tr
                      key={index}
                      className={`border-b border-gray-200 hover:bg-blue-50 cursor-pointer transition-colors ${
          ...
          >
            ...
            <div className="px-6 py-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
              <table className="w-full">
                ...
                <tbody>
                  {['NOLOGOUT'].filter(code => 
                    code.toLowerCase().includes(forNoLogoutSearchTerm.toLowerCase())
                  ).map((code, index) => (
                    <tr
                      key={index}
                      className={`border-b border-gray-200 hover:bg-blue-50 cursor-pointer transition-colors ${
      ...
      {/* Supervisory Group Code Search Modal */}
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-end gap-3">
                ...
                <input
                  ...
                  onChange={(e) => setSupervisoryGroupSearchTerm(e.target.value)}
                  className="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder=""
                />
              </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    { code: '1', desc: 'Batangas1 Balagtas Monthly Payroll' },
                    { code: '10', desc: 'Batangas Monthly Cash Payroll with Paycard' },
                    { code: '100', desc: 'Main Batangas Monthly' },
                    { code: '101', desc: 'Main Batangas Daily' },
                    { code: '102', desc: 'Main Batangas Daily with Paycard' },
                    { code: '103', desc: 'Main Batangas Monthly' },
                    { code: '104', desc: 'Main Batangas Monthly with Paycard' },
                    ...
                    .filter(item => 
                      ...
                      item.code.toLowerCase().includes(supervisoryGroupSearchTerm.toLowerCase()) ||
                      item.desc.toLowerCase().includes(supervisoryGroupSearchTerm.toLowerCase())
                    )
                    .map((item, index) => (
                    <tr 
                      key={item.code}
                      ...
                      onClick={() => {
                        setSupervisoryGroupCode(item.code);
                        setShowSupervisoryGroupModal(false);
                      }}
                    >
                      <td className="py-2 text-gray-800">{item.code}</td>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    .filter(item => 
                      otCodeSearchTerm === '' ||
                      item.code.toLowerCase().includes(otCodeSearchTerm.toLowerCase()) ||
                      item.desc.toLowerCase().includes(otCodeSearchTerm.toLowerCase())
                    )
                    .map((item, index) => (
                    <tr 
                      key={item.code}
