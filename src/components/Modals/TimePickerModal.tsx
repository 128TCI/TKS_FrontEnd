...
export function TimePicker({ onTimeSelect, onClose, initialTime = '' }: TimePickerProps) {
    ...
    return (
        <>
            ...
            {/* Picker Modal */}
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white border border-gray-200 rounded-lg shadow-2xl z-50 w-80 max-h-[80vh] flex flex-col">
                {/* Header — sticky, never scrolls */}
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3 rounded-t-lg flex items-center justify-between flex-shrink-0">
                ...
                {/* Action Buttons — sticky at bottom, never scrolls */}
                <div className="px-4 pb-4 pt-2 flex gap-2 flex-shrink-0 border-t border-gray-100 bg-white rounded-b-lg">
                    <button
                        onClick={onClose}
