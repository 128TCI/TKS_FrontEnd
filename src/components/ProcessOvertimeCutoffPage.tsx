...
export function ProcessOvertimeCutoffPage() {
  ...
  const [overtimeDate, setOvertimeDate] = useState('5/5/2021');
  const [showCalendar, setShowCalendar] = useState<'dateFrom' | 'dateTo' | 'overtimeDate' | null>(null);
  ...
  const employeeItems: EmployeeItem[] = [
    { id: 1, code: '000878', name: 'Last, First A', status: 'active' },
    { id: 2, code: '000900', name: 'Last, First A', status: 'active' },
    { id: 3, code: '000901', name: 'Last, First A', status: 'active' },
    { id: 4, code: '000903', name: 'Last, First A', status: 'active' },
    { id: 5, code: '000904', name: 'Last, First A', status: 'active' },
    { id: 6, code: '000905', name: 'Last, First A', status: 'active' },
    { id: 7, code: '000906', name: 'Last, First A', status: 'active' },
    { id: 8, code: '000907', name: 'Last, First A', status: 'active' },
    { id: 9, code: '000908', name: 'Last, First A', status: 'active' },
    { id: 10, code: '000942', name: 'Last, First A', status: 'active' }
  ];
  ...
  const handleCalendarClick = (field: 'dateFrom' | 'dateTo' | 'overtimeDate', event: React.MouseEvent<HTMLButtonElement>) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Define date range and overtime date</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Specify overtime cut-off</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Update to apply processing</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {showCalendar && (
        <CalendarPopup
          value={showCalendar === 'dateFrom' ? dateFrom : showCalendar === 'dateTo' ? dateTo : overtimeDate}
