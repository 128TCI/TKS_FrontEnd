...
export interface GroupSetUpOtherPoliciesItem {
  ...
  noOfHoursFrmUnderToAbsences?: number;
  tardinessToAbsences?: boolean;
  noOfHoursFrmTardiToAbsences?: number;
...
>(
  (
    ...
    const [noOfHoursFrmTardiToAbsences, setNoOfHoursFrmTardiToAbsences] =
      useState("4");
    const [compNoOfHoursEvnWOutLog, setCompNoOfHoursEvnWOutLog] =
      useState(false);
    ...
    const [showUnderTimeBrackModal, setShowUnderTimeBrackModal] =
      useState(false);
    ...
    const [underTimeBrackSearchTerm, setUnderTimeBrackSearchTerm] =
      useState("");
    ...
    const [allowBrackByEmpStatSearchTerm, setAllowBrackByEmpStatSearchTerm] =
      useState("");
    const [tardBracketItemList, setTardBracketItemList] = useState<
      BracketItem[]
    >([]);
    ...
    const [dailyScheduleList, setDailyScheduleList] = useState<
      DailySchedItem[]
    >([]);
    const [earningCodeList, setEarningCodesetList] = useState<
      EarningCodeItem[]
    >([]);
    ...
    const populateGroupSetUpOtherPolicies = (
      ...
      setDeductFirstHalfBeforeBracket(
        item.deductFirstHalfBeforeBracket ?? false,
      );
      ...
      setApplyLeaveForFirstHalfExempt(
        item.applyLeaveForFirstHalfExempt ?? false,
      );
    ...
    const fetchDailyScheduleSetUp = async (): Promise<DailySchedItem[]> => {
      const response = await apiClient.get(
        "/Fs/Process/DailyScheduleSetUp/All",
      );
    ...
    const handleSave = async () => {
      ...
      const updatedPayload: GroupSetUpOtherPoliciesItem = {
        ...
        accumulateUndertime,
        undertimeToAbsences,
        noOfHoursFrmUnderToAbsences: Number(noOfHoursFrmUnderToAbsences),
        tardinessToAbsences,
        noOfHoursFrmTardiToAbsences: Number(noOfHoursFrmTardiToAbsences),
      ...
      if (!isPayloadDifferent(updatedPayload, existingItem)) return;
    ...
    const handleSaveNew = async () => {
      ...
      try {
        const response = await apiClient.post(
          "/Fs/Process/TimeKeepGroup/GroupSetUpOtherPolicies",
          {
            ...
            noOfHoursFrmUnderToAbsences:
              Number(noOfHoursFrmUnderToAbsences) || 0,
            tardinessToAbsences,
            noOfHoursFrmTardiToAbsences:
              Number(noOfHoursFrmTardiToAbsences) || 0,
            compNoOfHoursEvnWOutLog,
        ...
        const newItem: GroupSetUpOtherPoliciesItem = response.data ?? {
          id: 0,
          groupCode: tksGroupCode,
        };
        setGroupSetUpOtherPoliciesList([newItem]);
        populateGroupSetUpOtherPolicies(newItem);
        // ✅ No success Swal — parent handles it
      } catch (error: any) {
    ...
    const handleDelete = async () => {
      try {
        ...
        const existingItem = freshData.data?.find(
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNoOfHoursFrmUnderToAbsences(e.target.value)
                  }
                  readOnly={!isEditMode}
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNoOfHoursFrmTardiToAbsences(e.target.value)
                  }
                  readOnly={!isEditMode}
                  className={`w-20 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${!isEditMode ? "bg-gray-50" : ""}`}
                />
              ...
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-end gap-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setUnderTimeBrackSearchTerm(e.target.value)
                    }
                    className="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Search by code, description, or hours..."
                  />
          ...
          >
            ...
            >
              ...
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-end gap-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAccumulateBrackSearchTerm(e.target.value)
                    }
                    className="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Search by code, description, or hours..."
                  />
              ...
              <div className="flex items-center justify-between mt-3 px-6 pb-4">
                <div className="text-gray-600 text-xs">
                  Showing{" "}
                  {filteredACCBracket.length === 0
                    ? 0
                    : startACCBracketIndex + 1}{" "}
                  to {Math.min(endACCBracketIndex, filteredACCBracket.length)}{" "}
                  of {filteredACCBracket.length} entries
                </div>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mt-3 px-6 pb-4">
                <div className="text-gray-600 text-xs">
                  Showing{" "}
                  {filteredDailySched.length === 0
                    ? 0
                    : startDailySchedIndex + 1}{" "}
                  to {Math.min(endDailySchedIndex, filteredDailySched.length)}{" "}
                  of {filteredDailySched.length} entries
                </div>
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
              ...
              <div className="flex items-center justify-between mt-3 px-6 pb-4">
                <div className="text-gray-600 text-xs">
                  ...
                  to{" "}
                  {Math.min(
                    startAllowBracketCodeIndex +
                      paginatedAllowBracketCode.length,
